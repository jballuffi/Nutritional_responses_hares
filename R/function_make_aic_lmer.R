...
#function that makes AIC table with R2s for linear mixed models (lmer made models)
#modlist = supply a list of models
#modnames = supply a list of names that matches the models

make_aic_lmer <- function(modlist, modnames){
  #make AIC table
  ...
  R2s <- lapply(modlist, collectR2_mixed)
